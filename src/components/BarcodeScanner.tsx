...
export default function BarcodeScanner({
  ...
  return (
    <div className="h-full flex flex-col bg-white dark:bg-gray-800 rounded-lg shadow p-6 space-y-4">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2">
        <input
          ...
          className="flex-1 min-h-[44px] px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
        />
        <button
          type="submit"
          disabled={loading || manualCode.length < 8}
          className="min-h-[44px] touch-manipulation px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 disabled:opacity-50"
        >
